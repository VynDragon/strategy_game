...
#include "rocket_scene/map.h"

#include "ui/ui_style.h"

typedef struct Rocket_Scene_Data_s {
...
static void add_smonk(Rocket_Scene_Data *scene_data)
{
...
static Rocket_Scene_Data rocket_scene_data = {0};

static void rocket_scene_init(Engine_Scene *scene)
{
	Rocket_Scene_Data *scene_data = (Rocket_Scene_Data*)scene->data;
 ...
 //
	// scene_data->billboard = engine_add_object(scenes_rocket_scene_billboard);
...
static void rocket_scene_pf(Engine_Scene *scene)
{
	// Rocket_Scene_Data *scene_data = (Rocket_Scene_Data*)scene->data;
 //
...
static void rocket_scene_deinit(Engine_Scene *scene)
{
	Rocket_Scene_Data *scene_data = (Rocket_Scene_Data*)scene->data;
...
static Filter_f rocket_scene_filters[] = {
	//filter_bloom,
};

Engine_Scene rocket_scene = {
	.pf = rocket_scene_pf,
	.inf = rocket_scene_init,
	.dif = rocket_scene_deinit,
	.data = &rocket_scene_data,
	.filters = rocket_scene_filters,
	.filters_count = ARRAY_SIZE(rocket_scene_filters),
	.statics = map,
